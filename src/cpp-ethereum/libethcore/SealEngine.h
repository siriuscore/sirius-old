...
////////////////////////////////////////////////////////////// // sirius
	void setSiriusSchedule(EVMSchedule _siriusSchedule) const { siriusSchedule = _siriusSchedule; }

	EVMSchedule& getSiriusSchedule() const { return siriusSchedule; }
...
private:
	...
	mutable EVMSchedule siriusSchedule; // sirius
