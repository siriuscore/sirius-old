...
#include "genesis/siriusMainNetwork.cpp"
#include "genesis/siriusTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::siriusMainNetwork: return c_genesisInfoSiriusMainNetwork;
	case Network::siriusTestNetwork: return c_genesisInfoSiriusTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::siriusMainNetwork: return c_genesisStateRootSiriusMainNetwork;
	case Network::siriusTestNetwork: return c_genesisStateRootSiriusTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
