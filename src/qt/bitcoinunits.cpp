...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SIRX");
    case mBTC: return QString("mSIRX");
    case uBTC: return QString::fromUtf8("μSIRX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Siriuss");
    case mBTC: return QString("Milli-Siriuss (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Siriuss (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
