#ifndef SIRXVERSIONCHECKER_H
#define SIRXVERSIONCHECKER_H
...
class SiriusVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit SiriusVersionChecker(QObject *parent = 0);
    ~SiriusVersionChecker();
