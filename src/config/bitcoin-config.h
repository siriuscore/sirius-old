...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Sirius Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Sirius Core"
...
#define PACKAGE_BUGREPORT "https://github.com/siriusproject/sirius/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sirius Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sirius Core 0.15.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sirius"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://sirius.org/"
