...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 2880; // sirius first month, pow rewardhalves every 6 days
        ...
        vSeeds.push_back(CDNSSeedData("46.101.164.93", "46.101.164.93", false)); // Sirius european node
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("46.101.164.93", "46.101.164.93", false)); // Sirius testnet
