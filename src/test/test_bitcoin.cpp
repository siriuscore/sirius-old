...
////////////////////////////////////////////////////////////// sirius
        ...
        globalState = std::unique_ptr<SiriusState>(new SiriusState(dev::u256(0), SiriusState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::siriusTestNetwork)));
