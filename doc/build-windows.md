...
Below are some notes on how to build Sirius Core for Windows.
...
way. This will install to `c:\workspace\sirius`, for example:

    make install DESTDIR=/mnt/c/workspace/sirius
